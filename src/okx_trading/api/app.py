...
from okx_trading.api.middleware.audit import AuditMiddleware
from okx_trading.api.middleware.auth import AuthMiddleware
from okx_trading.api.routes import (
    account,
    approvals,
    blueprints,
    demo,
...
from okx_trading.api.routes.dependencies import set_multi_container
from okx_trading.api.schemas.common import ErrorResponse
from okx_trading.application.services.authorization import AuthorizationError
