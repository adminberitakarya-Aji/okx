...
from trading_grid.application.services.monitoring import AlertRule, AlertSeverity, MonitoringService
...
async def get_monitoring_dashboard() -> MonitoringDashboardResponse:
    ...
    for component, check_data in dashboard.get("health_checks", {}).items():
        from trading_grid.api.schemas.demo import HealthCheckResponse
